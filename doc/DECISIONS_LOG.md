...
- The entry screen is a phone-based login form with a local Egyptian mobile-number validation rule and explicit role selection. It does not claim to send or verify an OTP; the existing auth contract remains the future integration boundary.
